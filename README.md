...
`git clone https://www.github.com/lecoqhardi/WolverineFramework && chmod +x WolverineFramework/wolverine && sudo mv WolverineFramework/wolverine /bin && sudo mv WolverineFramework /etc`
